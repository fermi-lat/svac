...
void CalibrationDescription::prepareFill()
{
  ...
  std::string sql("INSERT INTO CalibrationDescription VALUES(:m_id, :m_location, :m_source, TO_DATE(:m_validStartTime, :timeFormat), TO_DATE(:m_validEndTime, :timeFormat), TO_DATE(:m_creationTime, :timeFormat), :m_software, :m_version, :m_hardware, :m_calibType, :m_procLevel, :m_status, :m_dataSize, :m_creator, :m_description)");
