...
//
#ifndef MonInput_ToT_con0_TowerPlane_h
#define MonInput_ToT_con0_TowerPlane_h
...
class MonInput_ToT_con0_TowerPlane: public MonInputObject{
 public:
  MonInput_ToT_con0_TowerPlane();
  ~MonInput_ToT_con0_TowerPlane();
