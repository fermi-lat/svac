...
//
#include "MonInput_AcdVetoA_AcdTileDigiId.h"
#include <iostream>
#include <cassert>

// User defined part 

#define NAME AcdVetoA_AcdTileDigiId
#define OUTBRANCH "AcdVetoA_AcdTileDigiId"
#define LEAF "AcdVetoA_AcdTileDigiId[604]/O"
#define INBRANCH "m_acdDigiCol"
//#define ACCESSOR capullo
#define MONSOURCE DigiEvent
#define INPUTSOURCE "DigiEvent"
#define DESCRIPTION "Vector[AcdTileDigiId] reporting the existence (1) or not (0) of a Veto from PMT A in acdtile (digi id)"
#include "digiRootData/DigiEvent.h"

// End user defined part 

MonInput_AcdVetoA_AcdTileDigiId::MonInput_AcdVetoA_AcdTileDigiId(){
  m_name=OUTBRANCH;
}
MonInput_AcdVetoA_AcdTileDigiId::~MonInput_AcdVetoA_AcdTileDigiId(){
}
...
int MonInput_AcdVetoA_AcdTileDigiId::setOutputBranch(TTree* tree) {
 TBranch* bErr= tree->Branch(OUTBRANCH,m_val,LEAF);
 return bErr != 0 ? 0 : 1;
}
void MonInput_AcdVetoA_AcdTileDigiId::enableInputBranch(TTree& tree){
  tree.SetBranchStatus(INBRANCH,1);
}
void MonInput_AcdVetoA_AcdTileDigiId::setValue(TObject* event) {
...
std::string MonInput_AcdVetoA_AcdTileDigiId::getInputSource(){
  return INPUTSOURCE;
}
std::string MonInput_AcdVetoA_AcdTileDigiId::getDescription(){
  return DESCRIPTION;
}
