...
// Description
/*
This is a macro that produces nice ACD hit maps, as designed by the BARI group. It uses histograms produced by the monitoring job on digi root files with the configuration file monconfig_digi_histos.xml. The program is based on the macro from Nicola Mazziota and Silvia Raino, called ACDCountsMapPlot.C.
