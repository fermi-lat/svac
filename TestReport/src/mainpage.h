...
<li> TestReport.exe. It read data from a digi root file, analyze it and produce
 a text file containing some plots/tables of test results. It also reads a job
...
<li> ../pl/GenTestReport.pl. It is used to run TestReport.exe, then latex to
produce a ps file, then run ps2pdf to produce a pdf file. </li>
</ul>
