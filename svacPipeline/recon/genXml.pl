...
<pipeline
    ...
    <processing-step name=\"mergeMerit\" executable=\"mergeMerit\" batch-job-configuration=\"glastdataq-job\">
                    <input-file name=\"meritChunks\"/>
                    <output-file name=\"merit\"/>
    </processing-step>
    <processing-step name=\"mergeCal\" executable=\"mergeCal\" batch-job-configuration=\"glastdataq-job\">
