...
void NtupleDef::reset()
{
  ...
  m_contextRunInfoID         = -9999;
  m_contextRunInfoStartTime  = -9999;

  m_contextDataGramInfoModeChanges = -9999;
  m_contextDataGramInfoDatagrams   = -9999;
  ...
  m_contextLsfTimeTimeToneCurrentIncomplete      = -9999;
  m_contextLsfTimeTimeToneCurrentTimeSecs        = -9999;
  m_contextLsfTimeTimeToneCurrentFlywheeling     = -9999;
  m_contextLsfTimeTimeToneCurrentFlags           = -9999;
  ...
  m_contextLsfTimeTimeToneCurrentGemTimeHacks    = -9999;
  m_contextLsfTimeTimeToneCurrentGemTimeTicks    = -9999;

  m_contextLsfTimeTimeTonePreviousIncomplete      = -9999;
  m_contextLsfTimeTimeTonePreviousTimeSecs        = -9999;
  m_contextLsfTimeTimeTonePreviousFlywheeling     = -9999;
  m_contextLsfTimeTimeTonePreviousFlags           = -9999;
  ...
  m_contextLsfTimeTimeTonePreviousGemTimeHacks    = -9999;
  m_contextLsfTimeTimeTonePreviousGemTimeTicks    = -9999;
  m_contextLsfTimeTimeToneGemTimeHacks            = -9999;
  m_contextLsfTimeTimeToneGemTimeTicks            = -9999;
  m_contextLsfTimeTimeTicks                       = -9999;
  ...
  for (int iAcdTkr=0; iAcdTkr < 2; iAcdTkr++) {
    for (int iAcdTiles=0; iAcdTiles < 6; iAcdTiles++) {
      ...
      m_acdPocaSlopeX[iAcdTkr][iAcdTiles]     = -9999.0;
      m_acdPocaSlopeY[iAcdTkr][iAcdTiles]     = -9999.0;
